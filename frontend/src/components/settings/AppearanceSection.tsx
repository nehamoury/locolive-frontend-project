        ...
        <div className="p-8 space-y-10">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-[15px] font-black text-text-base">App Theme</h3>
                <p className="text-[12px] text-text-muted font-bold">Switch between light and dark mode</p>
              </div>
            </div>

            <div className="flex bg-bg-base/80 p-1 rounded-2xl border border-border-base/30">
              <button 
